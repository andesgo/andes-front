...
import Image from 'next/image'
import Link from 'next/link'
import { ShoppingBag, Plus, Trash2, Send, ArrowLeft, Package, User, Mail, Phone, MapPin, Link as LinkIcon, Search } from 'lucide-react'
...
export default function SolicitarPage() {
  ...
  const addProduct = (type: ProductType) => {
    ...
    const newProduct: ProductItem = type === 'with_link'
      ? { ...baseProduct, type: 'with_link', url: '', color: '', size: '', notes: '' }
